            ...
            <form action="/pesanan/{{$pesanan->id}}" method="post"  enctype="multipart/form-data">
                ...
                @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" 
                        required="required" name="tgl_pesan"  value="{{$pesanan->tgl_pesan}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="tgl_pengiriman">TGL_Pengiriman<label>
                        <input type="text" class="form-control" 
                        required="required" name="tgl_pengiriman"  value="{{$pesanan->tgl_pengiriman}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="total">Total</label>
                        <input type="text" class="form-control" 
                        required="required" name="total"  value="{{$pesanan->total}}"></br>
                    </div>
