...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="form-group">
                <label for="pelanggan_id">Nama Pelaggan</label>
                <div class="col-sm-12">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        required="required" name="tgl_pesan" ></br>
                    </div class="form-group">
                        <div class="form-group">
                        <label for="tgl_pengiriman">Tgl Pengiriman</label>
                        <input type="text" class="form-control" 
                        required="required" name="tgl_pengiriman"></br>
                    </div>
                    <div class="form-group">
                <label for="alamat_pelanggan">Alamat Pelaggan</label>
                <div class="col-sm-12">
                    <div class="form-group">
                        <select class="form-control" name="alamat_pelanggan">
                            @foreach($pelanggan as $a)
                             <option value='{{ $a->id }}'>{{ $a->id }} - {{ $a->alamat_pelanggan }}</option>
                            @endforeach
                        </select>   
                    </div>
                </div>
