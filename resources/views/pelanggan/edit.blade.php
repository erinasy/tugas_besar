        ...
        <div class="col-md-8">
            ...
            <form action="/pelanggan/{{$pelanggan->id}}" method="post">
                ...
                <div class="form-group">
                        ...
                        required="required" name="username" value="{{$pelanggan->username}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="name">Nama</label>
                        <input type="text" class="form-control" 
                        required="required" name="name" value="{{$pelanggan->name}}"></br>
                    </div>
                        <div class="form-group">
                        <label for="jenis_kelamin">Jenis Kelamin</label>
                        <input type="text" class="form-control" 
                        required="required" name="jenis_kelamin" value="{{$pelanggan->jenis_kelamin}}"></br>
                    </div class="form-group">
                        <div class="form-group">
                        <label for="alamat_pelanggan">Alamat Pelanggan</label>
                        <input type="text" class="form-control" 
                        required="required" name="alamat_pelanggan" value="{{$pelanggan->alamat_pelanggan}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="nomor_telepon">Nomor Telepon</label>
                        <input type="text" class="form-control" 
                        required="required" name="nomor_telepon" value="{{$pelanggan->nomor_telepon}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="nomor_telepon">Email</label>
                        <input type="text" class="form-control" 
                        required="required" name="email" value="{{$pelanggan->email}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="nomor_telepon">Password</label>
                        <input type="text" class="form-control" 
                        required="required" name="password" value="{{$pelanggan->password}}"></br>
                    </div>
