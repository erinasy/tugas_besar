              ...
              <br>
                <div class="card-body">
                    ...
                    <table class="table table-responsive">
                        <tr>
                            <tr><th>Username</th><th>:</th><td>{{ $pelanggan->username }}</td></tr>
                            <tr><th>Name</th><th>:</th><td>{{ $pelanggan->name }}</td></tr>
                            <tr><th>Jenis Kelamin</th><th>:</th><td>{{ $pelanggan->jenis_kelamin }} </td></tr>
                            <tr><th>Alamat Pelanggan</th><th>:</th><td>{{$pelanggan->alamat_pelanggan}}</td></tr>
                            <tr><th>Nomor Telepon</th><th>:</th><td>{{$pelanggan->nomor_telepon }}</td></tr>
                            <tr><th>Email</th><th>:</th><td>{{ $pelanggan->email }}</td></tr>
                            <tr><th>Created At</th><th>:</th><td>{{ $pelanggan->created_at }}</td></tr>
                        </tr>
                    </table>
