...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-20">
            ...
            @endif
            <a href="/pelanggan/create" class="btn btn-primary">Add Data</a> 
                    <br><br>
                    ...
                    @foreach($pelanggan as $s)
                     <tr>
                         ...
                         <td>{{ $s->alamat_pelanggan}}</td>
                         <td>{{ $s->nomor_telepon}}</td>
                         <td>{{ $s->email}}</td>
                         <td>
                            <form action="/pelanggan/{{$s->id}}" method="post">
                             <a href="/pelanggan/{{$s->id}}/edit" class="btn btn-warning">Edit</a>
                             <a href="/pelanggan/{{$s->id}}" class="btn btn-info">View</a>
                                 @csrf
                                 @method('DELETE')
