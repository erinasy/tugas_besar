        ...
        <div class="col-md-8">
            ...
            <form action="/produk/{{$produk->id}}" method="post"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        required="required" name="name"  value="{{$produk->name}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="keterangan">Keterangan</label>
                        <input type="text" class="form-control" 
                        required="required" name="keterangan"  value="{{$produk->keterangan}}"></br>
                    </div class="form-group">
                    <div class="form-group">
                        <label for="stok">Stok</label>
                        <input type="text" class="form-control" 
                        required="required" name="stok"  value="{{$produk->stok}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="harga">Harga</label>
                        <input type="text" class="form-control" 
                        required="required" name="harga"  value="{{$produk->harga}}"></br>
                    </div>
                    <div class="form-group">
