            ...
            <form action="/admin/{{$admin->id}}" method="post">
                ...
                @method('PUT')
                    <div class="form-group">
                        ...
                        required="required" name="username" value="{{$admin->username}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="name">Nama</label>
                        <input type="text" class="form-control" 
                        required="required" name="name" value="{{$admin->name}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="nomor_telepon">Email</label>
                        <input type="text" class="form-control" 
                        required="required" name="email" value="{{$admin->email}}"></br>
                    </div>
                    <div class="form-group">
                        <label for="nomor_telepon">Password</label>
                        <input type="text" class="form-control" 
                        required="required" name="password" value="{{$admin->password}}"></br>
                    </div>
