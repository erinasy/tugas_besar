    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description">Flower House adalah sebuah toko yang menjual bunga hias yang dapat digunakan untuk berbagai acara yang dalam dibeli secara online yang dapat diakses oleh siapa saja.</p>
        ...
        <div class="container">
          <div class="row margin-bottom-60">
            ...
            <div class="col-lg-5 col-md-5 tm-footer-div">
              ...
              <p class="margin-top-15">Flower House adalah sebuah toko yang menjual bunga hias yang dapat digunakan untuk berbagai acara yang dalam dibeli secara online yang dapat diakses oleh siapa saja.</p>
              <p class="margin-top-15">Pada toko kami juga menyediakan pesanan yang akan sesuai dengan keinginnan dan dapat request sesuai dengan apa yang diingkan pembeli. Pada toko Flower House akan mengutamakan kepuasan pelanggan.</p>
            </div>
